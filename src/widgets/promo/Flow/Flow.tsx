...
import variety_of_vr_games_and_play_areas
    from '../../../../public/gallery/variety_of_vr_games_and_play_areas_little.png'
import photos_and_videos from '../../../../public/gallery/photos_and_videos_little.png'
    ...
    return <div id={'flow'} className={promoStyles.contentBlock} style={{backgroundColor: "#685BC7"}}>
        ...
        <div className={promoStyles.cardsWrapper}>
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic1'} onClick={envocePic} src={instruction} alt={'instruction'}
            ...
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic2'} onClick={envocePic} src={spacious_arena} alt={'spacious_arena'}
                       className={compStyles.video}/>
            ...
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic3'} onClick={envocePic} src={comfortable_lounge} alt={'comfortable_lounge'}
                       className={compStyles.video}/>
            ...
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic4'} onClick={envocePic} src={variety_of_vr_games_and_play_areas}
                       alt={'variety_of_vr_games_and_play_areas'}
                       className={compStyles.video}/>
            ...
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic5'} onClick={envocePic} src={variety_of_vr_games_and_play_areas}
                       alt={'variety_of_vr_games_and_play_areas'}
                       className={compStyles.video}/>
            ...
            <div className={compStyles.card}>
                ...
                <Image data-name={'pic6'} onClick={envocePic} src={photos_and_videos} alt={'photos_and_videos'}
                       className={compStyles.video}/>
