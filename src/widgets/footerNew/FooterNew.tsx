    ...
    return <div id={'contacts'} className={compStyles.footer}>
        ...
        <div className={compStyles.flipper}>
            <div className={compStyles.left}>
                ...
                <div className={compStyles.el}>Телефон: 89027100210</div>
                <div className={compStyles.el}>E-mail: vertigosar64@gmail.com</div>
                <div className={compStyles.el}>Часы работы:</div>
                <div className={compStyles.el}>Ежедневно 10:00 - 21:00</div>
            </div>
